...
type PropTypes = {
  ...
  setProductUpdate: Dispatch<SetStateAction<Products | any>>;
  productUpdate: Products | any;
};

const ModalUpdateProduct = (props: PropTypes) => {
  const { setToaster, setDataProducts, productUpdate, setProductUpdate } =
    props;
  const [isLoading, setIsLoading] = useState(false);
  const [StockCount, setStockCount] = useState(productUpdate.stock);
  ...
  return (
    <Modal onClose={() => setProductUpdate({})}>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Select
          ...
          defaultValue={productUpdate.category}
        />
        <Input
          label="Price"
          name="price"
        ...
        <Button type="submit" isDisabled={isLoading}>
          {isLoading ? "Loading..." : "Change Product"}
        </Button>
      </form>
    </Modal>
  );
